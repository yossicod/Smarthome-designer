    ...
    <div className="home">
      <Navbar />
        <section className={"hero"}>
            ...
            <h1>
                Stop rendering, start creating: Transform sketches into reality at the speed of thought</h1>
                    ...
                    <div className={"project-card group"}>
                        ...
                        <div className={"card-body"}>
                            <div>
                                ...
                                <div className={"meta"}>
                                    <Clock size={16} />
                                    <span style={{ fontSize: '1.1rem' }}>{new Date('2026-04-19').toLocaleDateString()}</span>
                                    <span style={{ fontSize: '1.1rem' }}>By YossiCode</span>
                                </div>
                            </div>
                            <div className={"arrow"}>
